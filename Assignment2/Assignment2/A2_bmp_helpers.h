 ...
 *           out_bmp_filename [OUT] The new BMP to be created. Copy of in_bmp_filename
 *                                  except with the mask region set to the new color.
 *           top              [IN]  The highest row to include in the the mask
 *           left             [IN]  The leftmost column to include in the mask
 *           bottom           [IN]  The lowest row to include in the the mask
 *           right            [IN]  The rightmost column to include in the mask
